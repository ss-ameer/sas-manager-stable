...
export const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <div className={`sticky top-0 z-[100] w-full px-6 py-5 lg:px-8 border-b border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs ${className}`}>
