          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h2 className="text-lg font-bold tracking-tight text-white">Activity Log Profile</h2>
          ...
          <div className="space-y-2">
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-slate-200 text-xs font-sans whitespace-pre-wrap leading-relaxed min-h-[90px]">
              {(!currentUser || currentUser.role === 'Admin' || isRecordOwner(currentUser, entry) || currentUser.dataVisibilityTier !== 'BASIC') ? (
                ...
                <span className="text-purple-300 font-medium italic bg-purple-950/50 border border-purple-800/60 p-3 rounded-lg block">
                  🔒 Restricted &mdash; Notes are hidden under your assigned Basic View Tier.
                </span>
              )}
            </div>
          </div>
