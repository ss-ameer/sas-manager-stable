              ...
              <div className="flex flex-col md:flex-row items-center gap-3 mb-6">
                <div className="relative flex-1 w-full">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-200 focus:border-blue-500 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-850 placeholder:text-slate-400 focus:outline-none"
                  />
                </div>
                ...
                <div className="flex items-center space-x-2 w-full md:w-auto shrink-0">
                  <div className="relative flex items-center">
                    ...
                    <select
                      ...
                      className="bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-700 rounded-xl pl-8 pr-7 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none cursor-pointer shadow-2xs"
                    >
                      <option value="ALL" className="text-slate-900 bg-white">All Relationships</option>
                      {(companyRelationships || []).map((r) => (
                        <option key={r.id} value={r.name} className="text-slate-900 bg-white">{r.name}</option>
                      ))}
                    </select>
                  ...
                  <div className="relative flex items-center">
                    <select
                      ...
                      className="bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-700 rounded-xl pl-3 pr-7 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none cursor-pointer shadow-2xs"
                    >
                      <option value="ALL" className="text-slate-900 bg-white">All Temperatures</option>
                      {(companyTemperatures || []).map((t) => (
                        <option key={t.id} value={t.name} className="text-slate-900 bg-white">{t.name}</option>
                      ))}
                    </select>
                    <ChevronDown className="w-3.5 h-3.5 text-slate-400 absolute right-2.5 pointer-events-none z-10" />
                  </div>
